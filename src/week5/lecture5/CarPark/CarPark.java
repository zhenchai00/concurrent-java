package week5.lecture5.CarPark;
/*
@author  j.n.magee 
*/
...
public class CarPark extends Applet {
    ...
    ThreadPanel arrivals1;
    ThreadPanel arrivals2;
    ThreadPanel arrivals3;
    ...
    public void init() {
        super.init();
        // Set up Display
        arrivals1 = new ThreadPanel("Arrivals1", Color.blue);
        arrivals2 = new ThreadPanel("Arrivals2", Color.blue);
        arrivals3 = new ThreadPanel("Arrivals3", Color.blue);
        ...
        gridbag.setConstraints(arrivals1, gc);
        gridbag.setConstraints(arrivals2, gc);
        gridbag.setConstraints(arrivals3, gc);
    ...
    public void start() {
        ...
        arrivals1.start(new Arrivals(c));
