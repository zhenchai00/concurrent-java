...
class BridgeCanvas extends Canvas {
    ...
    BridgeCanvas(SingleLaneBridge controller) {
        ...
        crashSound = controller.getAudioClip(controller.getDocumentBase(), "classes/sound/crash.au");

        MediaTracker mt;
        mt = new MediaTracker(this);

        redCar = controller.getImage(controller.getDocumentBase(), "classes/image/redcar.gif");
        mt.addImage(redCar, 0);
        blueCar = controller.getImage(controller.getDocumentBase(), "classes/image/bluecar.gif");
        mt.addImage(blueCar, 1);
        bridge = controller.getImage(controller.getDocumentBase(), "classes/image/bridge.gif");
